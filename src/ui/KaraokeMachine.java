...
public class KaraokeMachine {
	...
	public KaraokeMachine(SongBook songBook) {
		...
		mMenu.put("play", "Play next song in the quesue");
	...
	private String promptAction() throws IOException {
		System.out.printf("There are %d songs available nad %d in the queue. Your options are: %n",
		...
		do {
			try {
				...
				case "add":
					...
					System.out.printf("%s adeed! %n%n", song);
					break;
				case "play":
					playNext();
					break;
	...
	private String promptArtist() throws IOException {
		System.out.println("Availabl artists:");
	...
	private Song promptSongForArtist(String artist) throws IOException {
		...
		System.out.printf("Avalibale songs for %s: %n ", artist);
	...
	public void playNext() {
		...
		if (song == null) {
			...
			System.out.printf("%n%n%n Open %s to hear %s by %s %n%n%n", song.getmVideoUrl(), song.getmArtist(),
					song.getmTitle());
		}
